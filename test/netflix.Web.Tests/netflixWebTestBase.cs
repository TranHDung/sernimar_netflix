...
{
    public abstract class netflixWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static netflixWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(netflixWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<netflixDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<netflixDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<netflixDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<netflixDbContext, Task<T>> func)
        {
            T result;
